...
class PatchRequest extends Method {
  const PatchRequest(final String path, {bool autoCastResponse = true})
...
class PutRequest extends Method {
  const PutRequest(final String path, {bool autoCastResponse = true})
...
class DeleteRequest extends Method {
  const DeleteRequest(final String path, {bool autoCastResponse = true})
