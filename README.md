...
Diopa is a type conversion [dio](https://github.com/flutterchina/dio/) client generator using [source_gen](https://github.com/dart-lang/source_gen) and inspired by [Chopper](https://github.com/lejard-h/chopper) and [Retrofit](https://github.com/square/retrofit).
...
import 'package:diopa_example/example.dart';
import 'package:dio/dio.dart';
...
For the project not to be confused with the files generated by the diopa you can hide them.
