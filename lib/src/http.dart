...
class GetRequest extends Method {
  const GetRequest([String? path, bool autoCastResponse = true])
...
class PostRequest extends Method {
  const PostRequest([String? path, bool autoCastResponse = true])
...
class PatchRequest extends Method {
  const PatchRequest([String? path, bool autoCastResponse = true])
      : super(HttpMethod.PATCH, path ?? '', autoCastResponse: autoCastResponse);
}

/// Make a `PUT` request
@immutable
class PutRequest extends Method {
  const PutRequest([String? path, bool autoCastResponse = true])
...
class DeleteRequest extends Method {
  const DeleteRequest([String? path, bool autoCastResponse = true])
      : super(HttpMethod.DELETE, path ?? '', autoCastResponse: autoCastResponse);
}

/// Make a `HEAD` request
@immutable
class HeadRequest extends Method {
  const HeadRequest([String? path, bool autoCastResponse = true])
      : super(HttpMethod.HEAD, path ?? '', autoCastResponse: autoCastResponse);
}

/// Make a `OPTIONS` request
@immutable
class OptionsRequest extends Method {
